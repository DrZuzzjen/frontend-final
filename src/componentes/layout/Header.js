...
<<<<<<< HEAD
  ...
  const [signbase, setSignbase] = React.useState(false);
  ...
  const handleNuevoProducto = () => {
    !auth.isAuthenticated() ? handleClickOpen() : history.push(`/product`);
  };
  ...
  return (
    <div className='bajo-navbar'>
      ...
      <Modal open={open} onClose={handleClose}>
        {signbase && <SignBase onbasein={handleSign} onbaseup={handleSignup} />}
        {signin && <Signin onSignin={handleSignin} onsingup={handleSignup} />}
...
>>>>>>> 90439c4f1267186b4fc28eb9118d8d6ea8aa59a4
}
